...
//#################################################
	...
	public AmazonProcessingTask2(Context context,
    	...
    	*/
		...
		try {  
	    	...
	    	//bucket  		= "sportxastbeta";	 //value = sportxastbeta
	    	this.bucket 			= GlobalVariablesHolder.S3_VIDEO_BUCKET; //value = sportxastbeta
	        ...
	        //	bucket 			= "sportxastbeta-images";		//value = sportxastbeta-images
	        	this.bucket 			= GlobalVariablesHolder.S3_IMAGE_BUCKET;		//value = sportxastbeta-images
	...
	protected S3TaskResult doInBackground(Object... params) { 
		...
		try { 
			...
			PutObjectRequest por = new PutObjectRequest(this.bucket, remoteFilePath, f);
