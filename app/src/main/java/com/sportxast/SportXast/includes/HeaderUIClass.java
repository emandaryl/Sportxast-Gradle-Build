...
public class HeaderUIClass {
    ...
    private void prepareHeader() {
        ...
        this.btn_follow 	= (Button)		    rlHeaderLayout.findViewById(R.id.btn_follow);
        ...
        this.btn_follow.setOnClickListener(	onFollowButtonClicked );
...
//########################################################################	 
    ...
    //########################################################################
    public void setFollowButtonText(final String followButtonText) {
        this.btn_follow.setText( followButtonText );
    }
    //########################################################################
    public void showFollowButton(final boolean isShow) {
        this.btn_follow.setVisibility(isShow ? View.VISIBLE : View.GONE);
    }
    //########################################################################
...
//########################################################################
    ...
    public OnClickListener onFollowButtonClicked = new OnClickListener() {
        @Override
        public void onClick(View v) {
            headerButtonClicked.onFollowClicked();
        }
    };
