...
public class HeaderListView extends RelativeLayout {
    ...
    private onUpdateListListener onUpdateList;
    ...
    public SectionAdapter getAdapter() {
    	return (SectionAdapter) mListView.getAdapter();
    }
    ...
    private class HeaderListViewOnScrollListener implements AbsListView.OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        	...
        	if(onUpdateList!=null){
    			onUpdateList.onDoUpdate(firstVisibleItem,visibleItemCount,totalItemCount);
    			}
    ...
    public interface onUpdateListListener{
    	public void onDoUpdate(int firstVisibleItem,  int visibleItemCount, int totalItemCount);
    }
    
    public void setOnUpdateListListener(onUpdateListListener eventListener) {
    	onUpdateList=eventListener;
    	}
